...
firstw=Tk()
firstw.title("GITA AUTONOMOUS COLLEGE BHUBANESWAR")
firstw.geometry("1600x1000+0+0")
label=Label(text="GITA AUTONOMOUS COLLEGE BHUBANESWAR",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("GITA AUTONOMOUS COLLEGE BHUBANESWAR")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="GITA AUTONOMOUS COLLEGE BHUBANESWAR", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("GITA AUTONOMOUS COLLEGE BHUBANESWAR")
    global entry1
    global entry2
    global entry3
    global entry4
